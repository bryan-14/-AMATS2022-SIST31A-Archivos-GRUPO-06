...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand" href="http://localhost/proyecto/admin/"; style="color:#FF0000;">administrar</a>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Bryan &copy; Your Website faboryte</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
